...
class autoencoder(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(
            in_channels=16, out_channels=4, kernel_size=5, stride=1)
        self.maxpool = nn.MaxPool2d(2, 2)
        # Encoder
        self.tconv1 = nn.ConvTranspose2d(
            in_channels=4, out_channels=16, kernel_size=5, stride=1, padding=2)
        self.tconv2 = nn.ConvTranspose2d(
            in_channels=16, out_channels=1, kernel_size=5, stride=1)
...
output_file = "/content/drive/MyDrive/Python Programs/Physics/results/superresolution_stenosis.pt"

file_prefix_in = "/content/drive/MyDrive/Python Programs/Physics/Data-driven-NN-data/low_fidelity/u_stenosis_lres__"
file_prefix_out = "/content/drive/MyDrive/Python Programs/Physics/Data-driven-NN-data/high_fidelity/u_stenosis_hres__"
...
K_train, K_test, label_train, label_test = train_test_split(
    k_all, label_all, test_size=num_testing, random_state=443)
...
for epoch in range(num_epochs):
    ...
    if epoch % 20 == 0:
        ...
        print('---Validation: epoch: {}. total {}, loss_test {}'.format(epoch,
              total, loss_test_total.item()))
        sys.stdout.flush()
